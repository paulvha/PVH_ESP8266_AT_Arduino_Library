/************************************************************
 ...
 This sketch will set the Arduino  + ESP8266 AT shield as a server
 on your local network and performs gpio test.
 ...
 AT library. It'll show you how to set an server, handle
...
///////////////////////////////////////////
// port 330 will be used for gpio test   //
///////////////////////////////////////////
...
void connectESP8266()
{
  ...
  int retVal = setmode(CUR,ESP8266_MODE_STA);
